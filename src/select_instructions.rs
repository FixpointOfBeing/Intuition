// use crate::{
//     explicate_control::{CAtom, CExpr, CStmt, CTail}, gensym::Gensym, llvm_ir::{types::{Typed, Types}, Instruction}, syntax::{BinOp, Ident, Type, UnaryOp}
// };
// use crate::llvm_ir::{
...
// fn type_to_llvm_ty(ty: &Type) -> TypeRef {
//     let types = Types::new();
//     match ty {
//         Type::Unit => types.void(),
//         Type::Bool => types.bool(),
//         Type::Int => types.i32(),
//         Type::Float => types.fp(FPType::Double),
//         Type::Arrow(input_ty, output_ty) => {
//             let param_type = type_to_llvm_ty(input_ty);
//             let result_type = type_to_llvm_ty(output_ty);
//             types.func_type(result_type, vec![param_type], false)
//         }
...
//             ty: type_to_llvm_ty(ty)
//         },
//     }
// }

// fn select_expr(dest: Reg, e: &CExpr, out: &mut Vec<Instruction>) {
//     match e {
//         CExpr::Atom(a) => {
...
// fn select_tail(tail: &CTail, gensym: &mut Gensym, out: &mut Vec<Instruction>) {
//     match tail {
//         CTail::Return(cexpr) => {
