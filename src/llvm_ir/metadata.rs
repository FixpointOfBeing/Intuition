...
pub enum DIMacroNode {
    ...
    MacroFile {
        file: MetadataRef<DIFile>,
        elements: Vec<MetadataRef<DIMacroNode>>,
        line: u32,
    },
}
...
pub enum DITemplateParameter {
    TypeParameter {
        name: String,
        ty: Option<MetadataRef<DIType>>,
    },
    ValueParameter {
        name: String,
        ty: Option<MetadataRef<DIType>>,
        value: Option<Box<Metadata>>,
        tag: DITemplateValueParameterTag,
    },
}
